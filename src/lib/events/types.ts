...
export type AppEvent =
  ...
  | { type: "material.updated"; data: Material }
  | { type: "material.deleted"; data: { id: string } }

  // Photos
  | { type: "photo.uploaded"; data: SitePhoto }
  | { type: "photo.deleted"; data: { id: string } }
  ...
  | { type: "roadmap.updated"; data: Roadmap }

  // Team
  | { type: "team.member_added"; data: User }
  | { type: "team.member_removed"; data: { id: string } }
  | { type: "team.member_role_changed"; data: User }
